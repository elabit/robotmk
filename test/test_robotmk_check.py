...
mock_inventory_robotmk_rules = eval(open('test/fixtures/inventory_rules/ruleset_level_0.py').read())
...
def test_inventory_mk(checks, monkeypatch):
    # Load Test values into 'inventory_robotmk_rules' in check module 
    monkeypatch.setattr(checks.module, "inventory_robotmk_rules", mock_inventory_robotmk_rules)
    # Define the patched function fo load inventory_robotmk_rules
