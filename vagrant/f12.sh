...
sshpass -p "vagrant" scp -P 2222 "$topdir"/target/x86_64-pc-windows-gnu/debug/robotmk.exe vagrant@127.0.0.1:"$agentbindir"
sshpass -p "vagrant" scp -P 2222 "$topdir"/target/x86_64-pc-windows-gnu/debug/robotmk_agent.exe vagrant@127.0.0.1:"$agentplugindir"
